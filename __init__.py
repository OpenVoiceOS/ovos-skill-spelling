...
class SpellingSkill(OVOSSkill):
    ...
    def ask_for_word(self) -> str:
        ...
        for _ in range(2):
            reply = self.get_response("what.word")
    ...
    def word_from_reply(self, reply: str) -> str:
        ...
        lines = Path(self.find_resource("Spell.intent", "locale")).read_text()
        samples = [l for l in lines.splitlines() if l and not l.startswith("#")]
