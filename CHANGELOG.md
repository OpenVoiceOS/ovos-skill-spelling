...
- fix\(locale\): skill.json examples match trained spell.intent lines [\#79](https://github.com/OpenVoiceOS/ovos-skill-spelling/pull/79) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- feat: cover the ways people ask for a spelling [\#56](https://github.com/OpenVoiceOS/ovos-skill-spelling/pull/56) ([JarbasAl](https://github.com/JarbasAl))
